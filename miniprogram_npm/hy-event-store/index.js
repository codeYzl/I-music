...
__DEFINE__(1685188077441, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1685188077442,"./event-store":1685188077443}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1685188077442, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1685188077443, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1685188077442,"./utils":1685188077444}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1685188077444, function(require, module, exports) {
...
return __REQUIRE__(1685188077441);
})()
